<div class="kt-image-input" data-kt-image-input="true">
    ...
    <div data-kt-image-input-placeholder="true" class="kt-image-input-placeholder" style="background-image: url({{ asset('admin_assets/media/avatars/blank.png') }})">
        <div data-kt-image-input-preview="true" class="kt-image-input-preview" style="background-image: url({{ $value }})"></div>
        <div class="flex items-center justify-center cursor-pointer h-5 left-0 right-0 bottom-0 bg-black/25 absolute">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" class="fill-gray-100 opacity-80">
