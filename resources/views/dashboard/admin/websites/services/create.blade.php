<x-dashboard.admin.layout.app>
    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="kt-card kt-card-grid min-w-full kt-card kt-card-accent mb-5">
            ...
            <form method="post" action="{{ route('dashboard.admin.websites.services.store') }}"
                   ...
                   {{-- Language Tabs --}}
                    ...
                    @foreach (getLanguages() as $language)
                        ...
                        <div id="tab_{{ $language->code }}" class="{{ $loop->first ? '' : 'hidden' }}">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <x-input.textarea name="description[{{ $language->code }}]" label="global.description" :required="$loop->first" />
                    ...
                    <div class="flex gap-4 items-center mt-3">
                        ...
                        <div class="flex-1">
                            ...
                            <a href="https://fonts.google.com/icons" target="_blank" class="text-xs text-primary hover:underline mt-1 inline-block">
